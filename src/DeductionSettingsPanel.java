...
public class DeductionSettingsPanel extends JPanel {
 ...
 private void save(){try{
  ...
  for(int r=0;r<slabs.getRowCount();r++)list.add(new TaxSlabStore.Slab(String.valueOf(slabs.getValueAt(r,0)).trim(),Double.parseDouble(String.valueOf(slabs.getValueAt(r,1)).trim()),Double.parseDouble(String.valueOf(slabs.getValueAt(r,2)).trim()),Double.parseDouble(String.valueOf(slabs.getValueAt(r,3)).trim())));
