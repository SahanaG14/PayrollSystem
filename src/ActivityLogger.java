...
public final class ActivityLogger {
    ...
    public static synchronized void log(String module,String action,String details,String status) {
        ...
        ENTRIES.add(e); append(e);
    }
    public static synchronized void logAs(String user,String module,String action,String details,String status) {Entry e=new Entry(LocalDateTime.now(),clean(module),clean(action),clean(details),clean(user),SESSION,clean(status));ENTRIES.add(e);append(e);}
