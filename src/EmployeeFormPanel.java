...
public class EmployeeFormPanel extends JPanel {
    ...
    private JComponent build() {
        ...
        JPanel grid=new JPanel(new GridBagLayout()); grid.setBorder(BorderFactory.createEmptyBorder(UIStyleUtility.MODULE_TOP_GAP,34,4,34));
    ...
    private static final class DatePickerDialog extends JDialog {
        ...
        private void rebuildDays(){
            ...
            for(int day=1;day<=ym.lengthOfMonth();day++){
                ...
                button.setEnabled(!value.isBefore(minimum)&&!value.isAfter(maximum));if(value.equals(selected)){button.setOpaque(true);button.setBackground(new Color(198,229,255));button.setForeground(new Color(20,48,76));button.setBorder(BorderFactory.createLineBorder(new Color(74,144,226),2));}
