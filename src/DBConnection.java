...
public final class DBConnection {
    ...
    static {File parent=DATABASE_FILE.getParentFile();if(parent!=null&&!parent.exists())parent.mkdirs();try{Class.forName("org.sqlite.JDBC");try(Connection connection=DriverManager.getConnection(URL);Statement statement=connection.createStatement()){statement.execute("PRAGMA journal_mode=WAL");statement.execute("PRAGMA synchronous=FULL");}}catch(Exception ignored){}}
